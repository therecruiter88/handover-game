const pinkSoldierMessages = {
    ...
    fourthChallengeOutro: "Now that the dust is set and the air seems more fresh...and you STILL didn't find out who is the person behind the mask, are you up for more two challenges? \n I know you are! \n I'm cooking up something new and maybe some enigmas to solve... \n 🔓 Stay tuned, it's coming soon... if you dare!",
    fourthChallengeIntro: "Guess who’s back for more? ⚡️ \n I was starting to think you forgot about the challenges. 👀 But fear not, the adventure isn't over yet! 🌟 \n Guess what? A mysterious vault awaits you with some secrets inside! 🔐 C'mon, hurry up... that vault isn’t going to open itself! 🔑 \n Give it a try, if you're brave enough! I’ll even give you 5 hints to help you solve the enigma. 🧩‍🕵️‍♂",
};
...
const pinkSoldierEnigmaHints = {
    ...
    hint4: "Some things are hidden behing color. Pay attention to the order...",
